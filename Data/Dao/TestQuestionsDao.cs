    ...
    public class TestQuestionsDao : LmsDao
    {
        ...
        public override int PerformInsertUpdateDelete(dynamic model, string operation)
        {
            ...
            {               
                ...
                "values('" + testQuestion.FkTestId + "','" + testQuestion.Question + "','" + testQuestion.Answer1 + "','" + testQuestion.Answer2 + "','" + testQuestion.Answer3 + "','" + testQuestion.Answer4 + "','" + testQuestion.CorrectAns + "','" + testQuestion.Explanation + "')";
            }
